 ...
 */
public class ClientCompComboBoxModel extends AbstractListModel implements ComboBoxModel {
    ...
    public ClientCompComboBoxModel(List<Client> clientList) {
        this(clientList, false);
    }

    public ClientCompComboBoxModel(List<Client> clientList, boolean onlyClients) {
